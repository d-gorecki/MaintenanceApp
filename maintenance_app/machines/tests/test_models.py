...
class MachineGroupTest(TestCase):
    ...
    def setUpTestData(cls):
        MachineGroup.objects.create(name="Test-group")

    def test_name_label(self):
        name = MachineGroup.objects.get(id=1)
...
class MachineTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Machine.objects.create(
            ...
            machine_group=MachineGroup.objects.get(id=1),
            name="Test-name",
            number="1111",
            producer="test",
    ...
    def test_factory_number_label(self):
        factory_number = Machine.objects.get(id=1)
    ...
    def test_number_label(self):
        number = Machine.objects.get(id=1)
